 ...
 * @author yugurimaru
 */
public class Pacientes_editar extends javax.swing.JFrame {

    private Paciente paciente;
    /**
     * Creates new form Pacientes_Inserir
     */
    public Pacientes_editar(Paciente paciente) {
    ...
    private void BT_salvarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BT_salvarMousePressed
        ...
        if (TF_nome.getText().equals("")) {
            ...
            paciente.setNome_pac(nome);
            paciente.setData_pac(dataNasc);
            paciente.setSexo(sexo);
            paciente.setFone(telefone);
            ...
            try {
                ...
                System.out.println("problema na edição do Paciente");
            }
            dispose();
        }
