...
public class Pacientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Data Nascimento", "Telefone", "Sexo"
            }
        ) {
    ...
    private void BT_adicionarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BT_adicionarMousePressed
        JFrame JanelaPacientes = new Pacientes_inserir();
        JanelaPacientes.setLocationRelativeTo(null); //Centraliza a Janela
    ...
    private void BT_editarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BT_editarMousePressed
        if (Linha_selecionada()) {
            ...
            Paciente Paciente_selecionado = Paciente.get(index);

            JFrame janelaEditar = new Pacientes_editar(Paciente_selecionado);
    ...
    private void BT_procurarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BT_procurarMousePressed
        JFrame JanelaPacientes = new Pacientes_procurar();
        JanelaPacientes.setLocationRelativeTo(null); //Centraliza a Janela
        JanelaPacientes.setVisible(true);
    ...
    private void Atualizar_tabela(){
        ...
        Tabela.removeAll();
        String id, nome, telefone, datas, sexo;
        ...
        for (int i = 0; i < Paciente.size(); i++) {
            id = Integer.toString(Paciente.get(i).getCodigo());
            nome = Paciente.get(i).getNome_pac();
            DateFormat dtOutput = new SimpleDateFormat("dd/MM/yyyy");
            datas = dtOutput.format(Paciente.get(i).getData_pac());
            telefone = Paciente.get(i).getFone();
            sexo = Paciente.get(i).getSexo() + "";

            table.addRow(new String[]{id, nome, datas, telefone, sexo  });
        }
    }
    //
    private void Excluir_linha_tabela() {
        ...
        if (Linha_selecioanda != -1) {
            ...
            Paciente Paciente_selecionado = Paciente.get(Linha_selecioanda);

            try {
                PacienteDAO PDAO = new PacienteDAO();
                // Envie o objeto Paciente para o método excluir no PacienteDAO
                PDAO.excluir(Paciente_selecionado);
                Atualizar_tabela();
            } catch (Exception e) {
